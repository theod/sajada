    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="100" height="100" data-play="playable" class="not-started playable">',
                ...
                '<circle class="progress-bar" cx="50" cy="50" r="45" stroke="#EEEEEE" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="8" transform="rotate(-90 50 50)"/>',
                '</g>',
                ...
                '<polygon points="30,25 80,50 30,75" fill="#EEEEEE" stroke-width="0"></polygon>',
                '</g>',
