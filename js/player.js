    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="100" height="100" data-play="playable" class="not-started playable">',
                ...
                '<line x1="40" y1="30" x2="40" y2="70" stroke="#becce1" stroke-opacity="0.25" fill="none" stroke-width="8" stroke-linecap="round"/>',
                '<line x1="60" y1="30" x2="60" y2="70" stroke="#becce1" stroke-opacity="0.25" fill="none" stroke-width="8" stroke-linecap="round"/>',
                '</g>',
