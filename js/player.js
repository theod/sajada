...
(function ($) {
    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="100" height="100" data-play="playable" class="not-started playable">',
                '<g class="shape">',
                '<circle class="progress-track" cx="50" cy="50" r="45" stroke="lightgray" stroke-opacity="0.5" stroke-linecap="round" fill="none" stroke-width="8"/>',
                '<circle class="precache-bar" cx="50" cy="50" r="45" stroke="gray" stroke-opacity="0.5" stroke-linecap="round" fill="none" stroke-width="8" transform="rotate(-90 50 50)"/>',
                '<circle class="progress-bar" cx="50" cy="50" r="45" stroke="#009EF8" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="8" transform="rotate(-90 50 50)"/>',
                '</g>',
                '<circle class="controls" cx="50" cy="50" r="42" stroke="none" fill="#030303" opacity="0.5" pointer-events="all"/>',
                '<g class="control pause">',
                '<line x1="40" y1="30" x2="40" y2="70" stroke="lightgray" stroke-opacity="0.5" fill="none" stroke-width="8" stroke-linecap="round"/>',
                '<line x1="60" y1="30" x2="60" y2="70" stroke="lightgray" stroke-opacity="0.5" fill="none" stroke-width="8" stroke-linecap="round"/>',
                '</g>',
                '<g class="control play">',
                '<polygon points="30,25 80,50 30,75" fill="#009EF8" stroke-width="0"></polygon>',
                '</g>',
